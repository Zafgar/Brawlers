...
var _time := 0.0
## Suurissa kartoissa staattinen pohja piirretään kerran ja animaatiot omassa
## kevyessä CanvasItem-kerroksessaan. Pienet legacy-kartat voivat edelleen
## animoida koko piirtonsa.
var animate_full_canvas := true
