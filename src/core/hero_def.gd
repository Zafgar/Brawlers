...
const HEROES := {
	...
	"kaira": {
		...
		"abilities": {
			...
			"a2": {"name": "Painepurkaus", "desc": "Kuluttaa raivoa ja purkaa poran kuumuuden kartiona. Tekee paljon vahinkoa koottuun leiriin ja hidastaa sankareita.", "cd": 6.5},
			"dodge": {"name": "Maadoituspiikki", "desc": "X ei ole hyppy: Kaira ankkuroituu, vetää lähiolennot sisään, keskeyttää monsterit ja saa osumien määrään perustuvan kilven.", "cd": 8.0},
			"ult": {"name": "Syväpora", "desc": "Pidä L2 ja sijoita valtava porakehä. Se vetää vihollisia keskustaan ja jauhaa objectivea kuuden sekunnin ajan — käytä vasta kun kohde voidaan lukita alueelle.", "cd": 0.0},
		},
	},
	"vesper": {
		"name": "Vesper",
	...
	"torq": {
		...
		"abilities": {
			...
			"a2": {"name": "Napaisku", "desc": "Magneettinen kaksipulssi: ensimmäinen vetää viholliset lähelle, toinen iskee ne ulospäin ja antaa lähellä oleville liittolaisille kilven.", "cd": 7.0},
			"dodge": {"name": "Ankkuritila", "desc": "X ei ole hyppy: Torq lukitsee jalat maahan, saa vahinkosuojaa ja CC-immuniteetin sekä vapauttaa lopuksi torjuvan paineaallon.", "cd": 9.0},
			"ult": {"name": "Nollavyöhyke", "desc": "Pidä L2 ja rakenna objective-alueelle linnoitus. Liittolaiset saavat suojan ja viholliset hidastuvat; paras käyttö on ennen contestia, ei sen jälkeen.", "cd": 0.0},
		},
	},
}
