...
const HEROES := {
	...
	"vesper": {
		...
		"abilities": {
			...
			"a2": {"name": "Sahalanka-ansa", "desc": "Pidä L1 ja sijoita ansa oikealla tatilla. Ensimmäinen vihollinen juurtuu; alue hidastaa ja leikkaa myös monsterilaumaa.", "cd": 9.0},
			"dodge": {"name": "Luotausdroni", "desc": "X ei ole väistöhyppy: lähettää nykyiseen paikkaan dronin, joka paljastaa puskat, merkitsee lähelle tulevat ja antaa Vesperille vauhtia kohti saalista.", "cd": 10.0},
			"ult": {"name": "Saartoristikko", "desc": "Pidä L2 ja sulje objective tai gank-reitti skannaavaan ristikkoon. Viholliset merkitään ja pulssit rankaisevat alueelle jäämisestä.", "cd": 0.0},
		},
	},
	"myria": {
		"name": "Myria",
		...
		"abilities": {
			...
			"a2": {"name": "Muuntopiiri", "desc": "Pidä L1 ja sijoita piiri. Sen vaikutus seuraa valittua essenssiä: tuli, kontrolli, tuki tai tyhjyys.", "cd": 8.0},
			"dodge": {"name": "Essenssivaihto", "desc": "X ei hyppää: vaihtaa seuraavaan talletettuun essenssiin, antaa lyhyen haamusuojan ja näyttää valinnan selvästi hahmon ympärillä.", "cd": 3.0},
			"ult": {"name": "Neljä Kaikua", "desc": "Pidä L2 ja sijoita suuri rituaali. Valittu essenssi määrää onko se tuho-, kontrolli-, pelastus- vai objective-ulti — väärä kaiku väärään tilanteeseen on hukattu mahdollisuus.", "cd": 0.0},
		},
	},
	"torq": {
		"name": "Torq",
